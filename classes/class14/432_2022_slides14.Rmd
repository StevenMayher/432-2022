...
knitr::include_graphics(here("figures", "ss01.png"))
```
...
If Harry and Larry have the same values for all other predictors but only Harry has private insurance, the model predicts Harry to have a value of log(`visits`) that is `r tidy(mod_1) %>% filter(term == "insuranceyes") %>% select(estimate) %>% round_half_up(., 3)` larger than Larry's log(`visits`).
...
knitr::include_graphics(here("figures", "ss02.png"))
```
...
```{r, echo = FALSE, fig.align = "center", out.height = '85%'}
knitr::include_graphics(here("figures", "ss03.png"))
```
...
```{r, echo = FALSE, fig.align = "center", out.height = '85%'}
knitr::include_graphics(here("figures", "ss04.png"))
```
...
```{r, echo = FALSE, fig.align = "center", out.height = '85%'}
knitr::include_graphics(here("figures", "ss05.png"))
```
