...
4. [Project B Outline and Scheduling Form](https://bit.ly/432-2022-projectB-register) is available now, and due **Sunday 2022-04-03 at 9 PM**. 
    ...
    - To fill out the form, you'll need 
        - a partner (if you want one), a title, your data ingested into R, a description of the data source, a pair of research questions, your two outcomes, your two modeling strategies, and counts of the data set size and the complete observations for each outcome. 
        - You'll also need to know when you (and your partner) are available April 25, 26 and 28 to match the 21 available time slots (of which you must pick 6, not all on the same day - options are morning and afternoon Monday and Tuesday, plus Thursday afternoon.)
