...
```{r, echo = FALSE, message = FALSE, fig.height = 6.5}
temp <- day7 %>%
    select(age, mcs, pcs, pss_fr, sex, subst, cesd)
...
- The right plot shows the impact of changing `subst` on `cesd` holding `mcs` at its median value which is `r median(day7$mcs)`.
