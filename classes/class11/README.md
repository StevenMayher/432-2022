...
We'll continue talking about the `tidymodels` packages today. I'll remind you that there's [a list in the Class 10 README](https://github.com/THOMASELOVE/432-2022/tree/main/classes/class10#the-tidymodels-packages) of some useful things to read if you want to learn more about or go further with this approach.
